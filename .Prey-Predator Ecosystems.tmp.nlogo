...
to setup
  ...
  set grass-regrowth-rate 5
  set fox-multiply-chance 0.25
  set rabbit-multiply-chance 0.25
...
to go
  ...
  ask foxes [
    ...
    if distance target-rabbit <= 1 [
      ...
      rt random 360
      fd   ; Move randomly if no rabbit nearby
    ]
